...
function inkzine_sanitize_checkbox( $input ) {
    if ( $input == 1 ) {
        return 1;
    } else {
        return '';
...
function inkzine_sanitize_positive_number( $input ) {
...
function inkzine_sanitize_category( $input ) {
...
function inkzine_sanitize_product_category( $input ) {
